...
# Session State Initialization (Fixes Language/Refresh issues)
...
def get_dtc_info(dtc_code):
    ...
    specific_db = {
        ...
        'P0300': {'desc_fr': 'Ratés d\'allumage', 'desc_ar': 'احتراق عشوائي', 'cause_fr': 'Bougies', 'cause_ar': 'البوجيات', 'solution_fr': 'Tester bougies', 'solution_ar': 'افحص البوجيات', 'prix': '100-500€', 'categorie': 'Allumage'},
        ...
        'B0000': {'desc_fr': 'Airbag', 'desc_ar': 'وسادة السائق', 'cause_fr': 'Airbag', 'cause_ar': 'الوسادة', 'solution_fr': 'Tester', 'solution_ar': 'افحص', 'prix': '200-800€', 'categorie': 'Airbag'},
        'U0100': {'desc_fr': 'Perte communication', 'desc_ar': 'فقدان اتصال', 'cause_fr': 'ECU', 'cause_ar': 'الكمبيوتر', 'solution_fr': 'Tester ECU', 'solution_ar': 'افحص الكمبيوتر', 'prix': '200-1000€', 'categorie': 'Réseau'},
    }
    ...
    try:
        ...
        for idx, row in df.iterrows():
            ...
            results.append({
                ...
                'Prix': info['prix'], 'Sévérité': severity, 'Statut': '✅ Connu' if is_known else 'ℹ️ Détecté'
            })
...
if st.session_state.results_df is not None:
    ...
    st.markdown('''<div class="glass-card" style="text-align: center; padding: 60px 40px;"><div style="font-size: 4em; margin-bottom: 20px;">🚗</div><h2 style="color: #1e293b; margin-bottom: 15px;">Bienvenue sur AutoDiag Pro</h2><p style="color: #64748b; font-size: 1.1em;">Système intelligent de diagnostic automobile avec analyse AI</p></div>''', unsafe_allow_html=True)
